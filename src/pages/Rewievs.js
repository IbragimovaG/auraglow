...
export default function Rewievs() {
  return (
    <div id='reviews' className='w-full h-auto relative '>
...
<div className='absolute lg:left-[37%] lg:top-[63%] xl:left-[37%] xl:top-[63%] md:left-[37%] md:top-[63%] top-[80%] left-0 z-10 p-10 w-[400px] h-[400px] bg-white'> 
