...
<div className='flex justify-between lg:px-28 xl:px-28 md:px-10 px-10 pt-40 '>
...
<h4 data-aos={'fade-down'} className='lg:text-2xl xl:text-2xl md:text-xl text-xl font-medium'>"I loved my smile before, and I love it more now! After a few treatments I saw noticeable results withput any sensitivity I've experienced with other products."</h4>
