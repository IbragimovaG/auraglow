  ...
  return (
    <div>
      <div className='flex items-center '>
        ...
        <h1 className='text-5xl lg:ml-[33%] xl:ml-[35%] md:ml-[22%] ml-10 text-[#08263F] my-10'>Shopping Basket</h1>
      ...
      {basket.length === 0 ? (
        <div className='w-[100%] h-[100vh] bg-[white] -mt-32'>
          ...
          <h1 data-aos={'fade-down'} className='text-center text-5xl mt-10 md:mt-32 text-[#08263F] font-thin  '>Your basket is empty.</h1>
        </div>
      ) : (
        <ul>
          {basket.map((item, index) => (
            <div data-aos={'fade-left'} className='w-[100%] h-100 lg:px-28 md:px-28 xl:px-28 px-10 flex lg:flex-row md:flex-row xl:flex-row flex-col mt-10 mb-32' key={index}>
              ...
              <div className='lg:w-[63%] md:w-[100%] xl:w-[70%] w-[100%] bg-white lg:px-20 md:px-20 xl:px-20 px-10 py-7'>
                ...
                <p>{item.price}</p>
                <img className='m-auto' width={280} src={item.img2} alt='' />
