  ...
  return (
    <div id='virtual_mirror' className='w-100 h-auto relative'>
      <div className='w-100 px-48 py-20 flex '>
        ...
        <div data-aos={'fade-left'} className='lg:w-96 xl:w-96 w-full lg:absolute h-100 p-8 bg-[#EDF3F6] lg:top-44 lg:right-28 xl:top-44 xl:right-52 hidden lg:block'>
      ...
      <div className='w-100 px-48 py-20 flex '>
      <div data-aos={'fade-right'} className='lg:w-96 xl:w-96 w-full lg:absolute h-100 p-8 bg-[#FBEED7] lg:bottom-32 lg:left-52 xl:bottom-44 xl:left-52 hidden lg:block'>
          <h1 className='text-[#031622] text-2xl font-medium pt-10'>
          30 days, risk-free
          </h1>
          <p className='my-10 pb-10 text-[#031622]'>
        ...
        <img width={1000} className='ml-64 lg:block xl:block md:hidden hidden lg:w-[80%]' src={require('../assets/woman.png')} alt="" />
      </div>
    </div>
  )
}
