...
export default function Navbar() {
  ...
  return (
    <div data-aos={'fade-down'} className={`flex z-50 lg:px-28 xl:px-28 px-10  w-[100%]  items-center justify-between h-20 fixed ${isScrolling ? 'backdrop-blur-lg fixed w-[100%] h-20' : ''}`}>
